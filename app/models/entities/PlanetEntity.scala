...
case class PlanetEntity(name: String, attributes: Attributes, systemCoordinates: Coordinates, orbitalCoordinates: Coordinates, signature: BigDecimal) extends OrbitalEntity {
